...
<div className="main-window">
   ...
   <div class="call-box">
	  ...
	  <h4>Get started by calling a friend below</h4>
		 ...
		 <a href="javascript:window.open('https://jitendra1405.github.io/Saasnic-CallingMain/client/src/html/chatting.html/?varName=admin&friend2=raj','mywindowtitle','top=250,left=950,width=400,height=400,toolbar=no,scrollbars=no,location=no,resizable =no')" class="btn-action fa fa-phone"></a>
      </div>
   </div>
</div>
);
