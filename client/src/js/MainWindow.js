   ...
   <div class="call-box">
	  ...
	  <h4 class="title">Get started by calling a friend below</h4>
         ...
         <button type="button" className="btn-action fa fa-phone"  onClick={this.callWithVideo12(false)}  />
    		 <a href="javascript:window.open('client/src/html/chatting.html','mywindowtitle','top=250,left=950,width=400,height=400,toolbar=no')" class="btn-action fa fa-commenting-o"></a>
